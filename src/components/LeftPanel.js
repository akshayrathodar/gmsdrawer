...
class LeftPanel extends React.Component {
  state = {
    ...
    activeFontFamily: "SuiseInt-Regular",
    pageminIndex:0,
    pagemaxIndex:6,
    pageMaxImageValue:55
  };
  handleChange(e) {
  ...
  nextElement = () => {
    console.log(this.state.pagemaxIndex , this.state.pageMaxImageValue);
    if(this.state.pagemaxIndex < this.state.pageMaxImageValue - 6) {
      this.setState({pageminIndex:this.state.pageminIndex+6,pagemaxIndex:this.state.pagemaxIndex+6});
    }
  }

  prevElement = () => {
    if(this.state.pageminIndex > 0) {
      this.setState({pageminIndex:this.state.pageminIndex-6,pagemaxIndex:this.state.pagemaxIndex-6});
    }
  }
  ...
  // setFontSize = (size) => {
  //   this.setActiveStyle("fontSize", size);
  ...
  // setTextBold = () => {
  //   var fontBoldValue =
  //     this.state.fontBoldValue === "normal" ? "bold" : "normal";
  //   this.setActiveStyle("fontWeight", fontBoldValue);
  //   this.state.fontBoldValue = fontBoldValue;
  // };
  // setTextItalic = () => {
  //   var fontItalicValue =
  //     this.state.fontItalicValue === "normal" ? "italic" : "normal";
  ...
  setFontStyle = (style) => {
    try {
      var canvas = this.props.canvas;
      var activeObject = canvas.getActiveObject();
      style === 'bold' ? activeObject.set("fontWeight",'bold') : activeObject.set("fontWeight",'normal');
      canvas.renderAll();
    } catch (e) {}
  }
  // pickerOpen = () => {
  ...
  render() {
    ...
    //   },
    // };
    const numbers = Array.from(Array(55).keys());
    numbers.shift();
    let pagenumber = numbers.slice(this.state.pageminIndex,this.state.pagemaxIndex);
    const listItems = pagenumber.map((number) => (
      <Draggable
        type="image"
        data={require("../images/img/sticker_gms-" +
          number.toString() +
          ".png")}
      >
        <span
          className={"pattern" + number.toString()}
          onClick={() =>
            this.addImage(
              require("../images/img/sticker_gms-" + number.toString() + ".png")
            )
          }
        ></span>
      </Draggable>
      ...
      <div className="leftpanelcontent">
            ...
            {/* <Row>
              <Col>
                <div className="solid-colors">
                  <p>LET'S PARTY</p>
                  <span
                    className="solidcol1 solidcolor"
                    onClick={() => this.setBGcolor("#d0021b")}
                  ></span>
                  <span
                    className="solidcol2 solidcolor"
                    onClick={() => this.setBGcolor("#f5a623")}
                  ></span>
                  <span
                    className="solidcol3 solidcolor"
                    onClick={() => this.setBGcolor("#f8e71c")}
                  ></span>
                  <span
                    className="solidcol4 solidcolor"
                    onClick={() => this.setBGcolor("#8b572a")}
                  ></span>
                  <span
                    className="solidcol5 solidcolor"
                    onClick={() => this.setBGcolor("#b8e986")}
                  ></span>
                  <span
                    className="solidcol6 solidcolor"
                    onClick={() => this.setBGcolor("#417505")}
                  ></span>
                  <span
                    className="solidcol7 solidcolor"
                    onClick={() => this.setBGcolor("#bd10e0")}
                  ></span>
                  <span
                    className="solidcol8 solidcolor"
                    onClick={() => this.setBGcolor("#4a90e2")}
                  ></span>
                  <span
                    className="solidcol9 solidcolor"
                    onClick={() => this.setBGcolor("#50e3ca")}
                  ></span>
                  <span
                    className="solidcol10 solidcolor"
                    onClick={() => this.setBGcolor("#000000")}
                  ></span>
                  <span
                    className="solidcol11 solidcolor"
                    onClick={() => this.setBGcolor("#ffffff")}
                  ></span>
            ...
            {/* <Row>
              <Col>
                <div className="gradients-colors">
                  ...
                  ></span>
                  <Popup
                    trigger={<span className="addcolor grdcolor">+</span>}
                    position="top right"
            ...
            <Row>
              <Col>
                <div className="patterns">
                  <p className="solid-colors-title">CHOOSE A TEMPLATE</p>
                  <Draggable
                    type="image"
                    data={require("../images/img/pattern1.jpg")}
                  >
                    <span
                      className="bg1"
                      onClick={() =>
                  ...
                  <Draggable
                    type="bgpattern"
                    data={require("../images/img/pattern2.jpg")}
                  >
                    <span
                      className="bg2"
                      onClick={() =>
                  ...
                  <Draggable
                    type="bgpattern"
                    data={require("../images/img/pattern3.jpg")}
                  >
                    <span
                      className="bg3"
                      onClick={() =>
                  ...
                  <Draggable
                    type="bgpattern"
                    data={require("../images/img/pattern4.jpg")}
                  >
                    <span
                      className="bg4"
                      onClick={() =>
                  ...
                  <Draggable
                    type="bgpattern"
                    data={require("../images/img/pattern5.jpg")}
                  >
                    <span
                      className="bg5"
                      onClick={() =>
                  ...
                  <Draggable
                    type="bgpattern"
                    data={require("../images/img/pattern6.jpg")}
                  >
                    <span
                      className="bg6"
                      onClick={() =>
                        this.applyBGPattern(require("../images/white.png"))
                      }
                    ></span>
                  </Draggable>
                </div>
        ...
        <TabPanel tabId="vertical-tab-three">
          <Container className="text-editer">
            <Row>
              <Col>
                <div className="patterns">{listItems}<button className="nextprevbtn" style={{marginRight:'180px'}} onClick={this.prevElement}>Prev</button><button className="nextprevbtn" onClick={this.nextElement}>Next</button></div>
              </Col>
            </Row>
          </Container>
        </TabPanel>
        <TabPanel tabId="vertical-tab-four">
          <Container className="text-editer">
            ...
            <Row>
              <Col>
                <div className="solid-colors">
                  <p className="solid-colors-title">COLOR</p>
                  <span
                    className="solidcol1 solidcolor"
                    onClick={() => this.setTextColor("#56B763")}
                  ></span>
                  <span
                    className="solidcol2 solidcolor"
                    onClick={() => this.setTextColor("#CCF5DE")}
                  ></span>
                  <span
                    className="solidcol3 solidcolor"
                    onClick={() => this.setTextColor("#FE4837")}
                  ></span>
                  {/* <span
                    className="solidcol4 solidcolor"
                    onClick={() => this.setTextColor("#5584E0")}
                  ></span>
                  <span
                    className="solidcol5 solidcolor"
                    onClick={() => this.setTextColor("#FCA305")}
                  ></span> */}
                  <span
                    className="solidcol6 solidcolor"
                    onClick={() => this.setTextColor("#202322")}
                  ></span>
                </div>
              </Col>
            ...
            <Col>
                <div className="solid-colors">
                  <p className="solid-colors-title">Font Style</p>
                    <span className="nextprevbtn"
                      onClick={() => this.setFontStyle("bold")}
                    >Bold</span>
                    <span className="nextprevbtn"
                      onClick={() => this.setFontStyle("")}
                    >Normal</span>
                </div>
              </Col>
            </Row>
            {/* <Row>
              <Col>
                <div className="font-size">
                  <p className="solid-colors-title">SIZE</p>
                  <select
                    name="font-size"
                    id="sizes"
