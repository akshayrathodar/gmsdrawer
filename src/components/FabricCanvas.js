...
import {saveCanvasState, initCenteringGuidelines, initAligningGuidelines} from "./Helpers";
        ...
        if (bgsrc) {
            ...
            fabric.Image.fromURL(bgsrc, (bg) => {
                ...
                if (canvasAspect >= imgAspect) {
                    scaleFactor = (this.canvas.width / bg.width);
                } else {
                    scaleFactor = (this.canvas.height / bg.height);
                }
                bg.set({
                    originX: "center",
                    originY: "center",
        ...
        return (
            <div className="main-area">
                <div className="canvasarea">
                    <Droppable
                        types={["image", "bgpattern"]}
                        onDrop={this.addImg.bind(this)}
                    >
